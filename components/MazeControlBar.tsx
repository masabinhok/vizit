// components/ControlBar.tsx (or a new MazeControlBar.tsx if you prefer separation)
'use client';
        ...
        <div className="flex items-center justify-between gap-6 flex-wrap lg:flex-nowrap">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <input
              ...
              className={`flex-1 max-w-32 px-4 py-3 text-sm rounded-xl border min-w-0 transition-all duration-200 ease-out backdrop-blur-sm shadow-md ${
                isDarkMode 
