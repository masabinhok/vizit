// app/algorithm/sieve-of-eratosthenes/page.tsx
'use client';
...
export default function SievePage() {
    ...
    const initializeAlgorithm = () => {
        try {
            ...
            const canvasWrapper = document.getElementById('sieve-canvas-wrapper');
            if (canvasWrapper) canvasWrapper.scrollTop = 0;
        } catch (err) {
                ...
                <header className={`relative p-6 flex-shrink-0 backdrop-blur-sm ${isDarkMode
                    ...
                    <div className="relative flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-6 animate-in slide-in-from-right-4 fade-in duration-600 delay-300">
                            <div className={`px-4 py-2 rounded-xl backdrop-blur-sm ${isDarkMode ? 'bg-slate-800/50 border border-slate-600/30' : 'bg-white/50 border border-gray-200/30'
                                ...
                                style={
                                    {
                                        ...
                                        // expose --bar-width to VisualizationCanvas + inner wrappers
                                        ['--bar-width' as any]: `${barWidth}px`
                                    }
                                }
                            >
