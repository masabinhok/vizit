...
import { modularArithmeticConfig } from '../../algorithms/modular-arithmetic';
...
export default function ModularArithmeticPage() {
  ...
  const algorithmConfig = modularArithmeticConfig;
  ...
  const initializeAlgorithm = () => {
    try {
      ...
      toast.error("Invalid input format. Please use integers separated by commas.");
    }
  };
