...
import TarjanSCCVisualization from '../../../components/TarjanSCCVisualization';
import { tarjanSCCConfig } from '../../algorithms/tarjan-scc';
...
export default function TarjanSCCPage() {
  ...
  return (
    <div className={`flex flex-col min-h-screen ${isDarkMode ? 'bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900' : 'bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/30'} transition-all duration-500 relative`}>
      ...
      <main className="flex-1 flex flex-col relative">
            ...
            <div className="flex items-center gap-6 animate-in slide-in-from-right-4 fade-in duration-600 delay-300">
              <div className={`px-4 py-2 rounded-xl backdrop-blur-sm ${isDarkMode
                ...
                <span className={`ml-2 font-mono font-bold ${isDarkMode ? 'text-amber-400' : 'text-amber-600'
                  ...
                  {tarjanSCCConfig.timeComplexity.average}
                </span>
              </div>
              <div className={`px-4 py-2 rounded-xl backdrop-blur-sm ${isDarkMode
                  ? 'bg-slate-800/50 border border-slate-600/30'
                ...
                <span className={`ml-2 font-mono font-bold ${isDarkMode ? 'text-emerald-400' : 'text-emerald-600'
                  ...
                  {tarjanSCCConfig.spaceComplexity}
                </span>
              </div>
            </div>
          </div>
        ...
        <section className="flex-1">
          <div className={`p-6 relative ${isDarkMode
