...
import { primeFactorizationConfig } from '../../algorithms/prime-factorization';
...
export default function PrimeFactorizationPage() {
  ...
  const algorithmConfig = primeFactorizationConfig;
  ...
  const initializeAlgorithm = () => {
    try {
      ...
      toast.error("Invalid input format. Please use a single positive integer (e.g., 84).");
    }
  };
