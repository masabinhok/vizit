...
import { dijkstraConfig } from '../../../app/algorithms/dijkstra';
...
export default function DijkstraPage() {
  ...
  const algorithmConfig = dijkstraConfig;
  ...
  const initializeAlgorithm = () => {
    try {
      const graphInput = inputArray.trim() || algorithmConfig.defaultInput;
      const newSteps = algorithmConfig.generateSteps(graphInput as any);
      setSteps(newSteps);
      setCurrentStep(0);
      ...
      alert("Invalid input format. Please use a valid JSON representation of a graph.");
    }
  };
