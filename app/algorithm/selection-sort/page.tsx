...
import { selectionSortConfig } from '../../../app/algorithms/selection-sort';
...
export default function SelectionSortPage() {
  ...
  const algorithmConfig = selectionSortConfig;
  ...
  const initializeAlgorithm = () => {
    try {
      ...
      if (numbers.length > 20) {
        setAlertMessage("Please enter no more than 20 numbers for better visualization");
        return;
      }
