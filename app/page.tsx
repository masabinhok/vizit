  ...
  return (
    <div className="flex h-screen">
      ...
      <main className={`flex-1 overflow-y-auto ${isDarkMode ? 'bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900' : 'bg-gradient-to-br from-slate-50 via-blue-50/30 to-purple-50/30'} transition-all duration-500 relative`}>
        ...
        <div className="min-h-screen flex items-center justify-center relative p-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-12">
              {/* Floating badge */}
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full backdrop-blur-md border mb-6 animate-in fade-in slide-in-from-top-4 delay-100 group hover:scale-102 hover:-translate-y-0.5 transition-all duration-200 ease-out">
              ...
              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-3 justify-center mb-12 animate-in slide-in-from-bottom-8 fade-in duration-1200 delay-600">
                <button
                  onClick={() => router.push('/algorithm/bubble-sort')}
                  className="group relative px-6 py-3 bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-blue-500/30 transition-all duration-200 ease-out hover:scale-105 hover:-translate-y-0.5 overflow-hidden"
                >
                  ...
                  <div className="relative flex items-center gap-2">
                    ...
                    <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-200 ease-out" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button
                  ...
                  className={`group px-6 py-3 rounded-xl font-semibold border-2 transition-all duration-200 ease-out hover:scale-105 hover:-translate-y-0.5 backdrop-blur-sm ${
                    isDarkMode 
                ...
                >
                  <div className="flex items-center gap-2">
                    <svg className="w-4 h-4 group-hover:rotate-6 transition-transform duration-200 ease-out" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
              ...
              <div className={`group p-6 rounded-2xl backdrop-blur-xl border transition-all duration-300 ease-out hover:-translate-y-1 ${
                isDarkMode 
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center shadow-lg group-hover:shadow-blue-500/30 group-hover:scale-105 transition-all duration-200 ease-out">
                  ...
                  <div className="flex-1">
                    <h3 className={`text-lg font-bold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-900'} group-hover:text-blue-500 transition-colors duration-200`}>
                      Real-time Interactive Visualization
                    </h3>
                    <p className={`text-sm leading-relaxed ${isDarkMode ? 'text-slate-400' : 'text-gray-600'}`}>
                      Watch algorithms come to life with smooth animations. Control playback speed and step through each operation.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className={`group p-6 rounded-2xl backdrop-blur-xl border transition-all duration-300 ease-out hover:-translate-y-1 ${
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-pink-600 flex items-center justify-center shadow-lg group-hover:shadow-purple-500/30 group-hover:scale-105 transition-all duration-200 ease-out">
                      <svg className="w-6 h-6 text-white group-hover:rotate-6 transition-transform duration-200 ease-out" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex-1">
                    <h3 className={`text-lg font-bold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-900'} group-hover:text-purple-500 transition-colors duration-200`}>
                      Code Analysis
                    </h3>
                    <p className={`text-sm leading-relaxed ${isDarkMode ? 'text-slate-400' : 'text-gray-600'}`}>
              ...
              <div className={`group p-6 rounded-2xl backdrop-blur-xl border transition-all duration-300 ease-out hover:-translate-y-1 ${
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-lg group-hover:shadow-emerald-500/30 group-hover:scale-105 transition-all duration-200 ease-out">
                      <svg className="w-6 h-6 text-white group-hover:rotate-6 transition-transform duration-200 ease-out" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex-1">
                    <h3 className={`text-lg font-bold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-900'} group-hover:text-emerald-500 transition-colors duration-200`}>
                      Learn by Doing
                    </h3>
                    <p className={`text-sm leading-relaxed ${isDarkMode ? 'text-slate-400' : 'text-gray-600'}`}>
                      Interactive tutorials with custom input data, detailed explanations, and progressive difficulty.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className={`group p-6 rounded-2xl backdrop-blur-xl border transition-all duration-300 ease-out hover:-translate-y-1 ${
                ...
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0">
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center shadow-lg group-hover:shadow-amber-500/30 group-hover:scale-105 transition-all duration-200 ease-out">
                      <svg className="w-6 h-6 text-white group-hover:rotate-6 transition-transform duration-200 ease-out" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="flex-1">
                    <h3 className={`text-lg font-bold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-900'} group-hover:text-amber-500 transition-colors duration-200`}>
                      Performance Analytics
                    </h3>
                    <p className={`text-sm leading-relaxed ${isDarkMode ? 'text-slate-400' : 'text-gray-600'}`}>
                      Compare algorithm efficiency with real-time metrics, memory tracking, and complexity analysis.
                    </p>
                  </div>
                </div>
              </div>
        ...
        } p-6 animate-in slide-in-from-bottom-4 fade-in duration-1000 delay-1600`}>
          <div className="max-w-4xl mx-auto">
            {/* Stats Grid */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
              <div className="text-center group">
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl mb-3 bg-gradient-to-br from-blue-500 to-blue-600 text-white shadow-lg group-hover:shadow-blue-500/25 group-hover:scale-110 transition-all duration-500`}>
              ...
              <div className="text-center group">
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl mb-3 bg-gradient-to-br from-purple-500 to-purple-600 text-white shadow-lg group-hover:shadow-purple-500/25 group-hover:scale-110 transition-all duration-500`}>
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
              ...
              <div className="text-center group">
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl mb-3 bg-gradient-to-br from-emerald-500 to-emerald-600 text-white shadow-lg group-hover:shadow-emerald-500/25 group-hover:scale-110 transition-all duration-500`}>
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C20.832 18.477 19.246 18 17.5 18c-1.746 0-3.332.477-4.5 1.253" />
                  </svg>
                </div>
                <div className={`text-2xl font-bold ${isDarkMode ? 'text-emerald-400' : 'text-emerald-600'} mb-1`}>
                  100%
                </div>
                <div className={`text-xs font-medium ${isDarkMode ? 'text-slate-400' : 'text-gray-600'}`}>
              ...
              <div className="text-center group">
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl mb-3 bg-gradient-to-br from-amber-500 to-orange-600 text-white shadow-lg group-hover:shadow-amber-500/25 group-hover:scale-110 transition-all duration-500`}>
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" />
                  </svg>
                </div>
                <div className={`text-2xl font-bold ${isDarkMode ? 'text-amber-400' : 'text-amber-600'} mb-1`}>
                  Real-time
                </div>
                <div className={`text-xs font-medium ${isDarkMode ? 'text-slate-400' : 'text-gray-600'}`}>
            ...
            {/* Bottom CTA */}
            <div className="text-center pt-6 border-t border-opacity-50">
              <p className={`text-sm mb-4 ${isDarkMode ? 'text-slate-300' : 'text-gray-600'}`}>
                Ready to master algorithms through visualization?
              </p>
              <button
                onClick={() => router.push('/algorithm/bubble-sort')}
                className="group inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-600 via-purple-600 to-emerald-600 text-white font-semibold rounded-xl shadow-2xl hover:shadow-blue-500/25 transition-all duration-500 hover:scale-105 hover:-translate-y-1 animate-gradient-x"
              >
